...
function App() {
  ...
  const requestResource = () => {
    ...
    setGraph(prev => {
      ...
      const oldEdges = newGraph[process] || [];     // ensure array exists
      const newEdges = [...oldEdges, resource];     // immutable array update

      newGraph[process] = newEdges;                 // assign immutably
      return newGraph;
    });
  ...
  const allocateResource = () => {
    ...
    setGraph(prev => {
      ...
      const oldEdges = newGraph[resource] || [];
      const newEdges = [...oldEdges, process];

      newGraph[resource] = newEdges;
      return newGraph;
    });
